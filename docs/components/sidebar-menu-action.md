...
```tsx
import { SidebarMenuAction } from '@csa-italy/havas-ui'
...
| `{
  ...
  showOnHover = false,
  ...props
}` | `ClassAttributes<HTMLButtonElement> & ButtonHTMLAttributes<HTMLButtonElement> & { asChild?: boolean | undefined; showOnHover?: boolean | undefined; }` | `-` | ✅ | — |
