...
**Sorgente:** `src/components/ui/card.tsx`
**Storybook:** [▶ Vedi la Live Demo](https://csa-italy.github.io/havas-ui/?path=/story/ui-card--docs)
...
```tsx
import { CardDescription } from '@csa-italy/havas-ui'
...
*Ultimo aggiornamento: 2026-04-16T17:16:14.741Z*