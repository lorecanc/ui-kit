...
**Sorgente:** `src/components/ui/kbd.tsx`
**Storybook:** [▶ Vedi la Live Demo](https://csa-italy.github.io/havas-ui/?path=/story/ui-kbd--docs)
...
```tsx
import { Kbd } from '@csa-italy/havas-ui'
...
|----------|------|---------|----------|-------------|
| `{ className, ...props }` | `DetailedHTMLProps<HTMLAttributes<HTMLElement>, HTMLElement>` | `-` | ✅ | — |
...
> ⚠️ Descrizione non disponibile per KbdGroup.
