...
**Sorgente:** `src/components/ui/table.tsx`
**Storybook:** [▶ Vedi la Live Demo](https://csa-italy.github.io/havas-ui/?path=/story/ui-table--docs)
...
```tsx
import { TableCaption } from '@csa-italy/havas-ui'
