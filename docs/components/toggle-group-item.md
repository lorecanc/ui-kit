...
```tsx
import { ToggleGroupItem } from '@csa-italy/havas-ui'
...
| `{
  ...
  size = "default",
  ...props
}` | `ToggleGroupItemProps & RefAttributes<HTMLButtonElement> & VariantProps<(props?: (ConfigVariants<{ variant: { default: string; outline: string; }; size: { default: string; sm: string; lg: string; }; }> & ClassProp) | undefined) => string>` | `-` | ✅ | — |
