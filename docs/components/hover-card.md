...
**Sorgente:** `src/components/ui/hover-card.tsx`
**Storybook:** [▶ Vedi la Live Demo](https://csa-italy.github.io/havas-ui/?path=/story/ui-hover-card--docs)
...
```tsx
import { HoverCard } from '@csa-italy/havas-ui'
