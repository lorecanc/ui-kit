...
**Sorgente:** `src/components/ui/empty.tsx`
**Storybook:** [▶ Vedi la Live Demo](https://csa-italy.github.io/havas-ui/?path=/story/ui-empty--docs)
...
```tsx
import { EmptyTitle } from '@csa-italy/havas-ui'
