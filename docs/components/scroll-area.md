...
**Sorgente:** `src/components/ui/scroll-area.tsx`
**Storybook:** [▶ Vedi la Live Demo](https://csa-italy.github.io/havas-ui/?path=/story/ui-scroll-area--docs)
...
```tsx
import { ScrollArea } from '@csa-italy/havas-ui'
