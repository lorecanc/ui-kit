...
**Sorgente:** `src/components/ui/alert.tsx`
**Storybook:** [▶ Vedi la Live Demo](https://csa-italy.github.io/havas-ui/?path=/story/ui-alert--docs)
...
```tsx
import { AlertAction } from '@csa-italy/havas-ui'
